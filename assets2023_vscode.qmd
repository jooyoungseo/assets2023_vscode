...
::: acks
We thank VS Code team for striving to create an accessible product, Isidor Nikolic for driving accessibility initiatives, Kai Maetzel for giving Megan and the team the green light to work on and prioritize accessibility issues, Daniel Imms for your knowledge, expertise, and ideas in this area, Raymond Zhao for improving the VS Code site's accessibility, Roberto Perez for your expertise and insights, José Vilmar Estácio de Souza for creating issues and testing features, Amnon Freidlin for working with users to select and improve upon audio cues
:::
